...
public class Sample5 {
    ...
    @Test
    public void clickAcceptOnAlertButton() {
        WebElement toSummonAlertButton2 = driver.findElement(By.className("w3-red"));
        toSummonAlertButton2.click();
        Alert alert = driver.switchTo().alert();
        String alertMsg = alert.getText();
        alert.accept();
        String expectedValue = "I am an alert box!";
    ...
    public void popUpToEnterNumber()
    {
        ...
        Assert.assertTrue(clickToEnterNumberBtn.isEnabled());
    ...
    {
        String number = "20";
        WebElement clickToEnterNumberBtn2 = driver.findElement(By.className("w3-khaki"));
        clickToEnterNumberBtn2.click();
        Alert alert = driver.switchTo().alert();
