...
public class Sample6 {
    ...
    public void findXpath()
    {
        ...
        WebElement element5 = driver.findElement(By.xpath("//div[@id='nonStandartText']/*[contains(@class,'text unbelievable')]"));
    ...
    public void findCssSelector()
    {
        ...
        WebElement element6 = driver.findElement(By.cssSelector("div#nonStandartText>.unbelievable"));
